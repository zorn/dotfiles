...
**Decisions** are documents that capture the details of important choices made during the development of this software, along with the context and consequences to be remembered.

These documents are an excellent opportunity to write down what was in your head during the development of a code change, the design of a feature, or the choice of one vendor or library over another. Having those details written down greatly benefits future contributors — including your future self — when they question why something was done a certain way.
